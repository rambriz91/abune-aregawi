  ...
  return (
    ...
    <div className='flex flex-col max-h-full items-center text-2xl georgia'>
      ...
      <p className='w-10/12 m-5'>
        ...
        ባህልና ጉባኤ የማንነታችን ሦስት ምሰሶዎች ናቸው። ብዙ ምእመናኖቻችን አማርኛ እና ትግራይ አቀላጥፈው ስለሚናገሩ
      ...
      <p className='w-10/12 m-5'>
        ...
        are fluent in Amharic and Tigray, learning English to communicate with
        and honor our local neighbors. We particularly welcome immigrants so we
        may help integrate them into our wonderful San Diego Community. Please
        join us at any of our weekly services. Send us an email and we will
